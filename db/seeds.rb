AdminUser.create!(email: 'admin@hitsteroid.com', password: 'A1L2p3y4', password_confirmation: 'A1L2p3y4')


iron_pharma = Marka.create name: "Iron pharma"
generics_pharma = Marka.create name: "Generics Pharma"
omega_meds = Marka.create name: "Omega Meds"
genesis_pharma = Marka.create name: "Genesis MedsJD Pharma"
jd_pharma = Marka.create name: "JD Pharma"
leon_labs = Marka.create name: "Leon Labs"
balkan = Marka.create name: "Balkan Pharma"
muscle = Marka.create name: "Muscle Labs"
kingtropin = Marka.create name: "Kigtropin"
axio = Marka.create name: "Axio labs"
Marka.create name: "Oxidine"
Marka.create name: "King peptides"
Marka.create name: "Norditropin"
Marka.create name: "Humantropin"
Marka.create name: "Gamma"


Product.create title: 'Iron Pharma Deca MİX 400 mg', description: 'Deca Mix 4 esterli Bir deca türevidir.Decadan kısaca bahsedecek olursak bulk amaçlı kullanılan en etkili maddedir.Definasyon döneminde kullanılması uygun olmaz.Bu sebebi Deca Vücuda kas kazanımı yaparken yanında tutacağı su kütlesinden dolayı hatlı görünümü engeller.Deca 19-a Grubu dahildir 17 grubuna göre çok daha yüksek anabolik güce sahiptir.Resöptörlere çok güçlü bağlanır yanında başka bir 19-a(örn trnbolone) grubu kullanıldığında resöptörü kapattığı için 2.19-a grubu maddemiz tam randımanlı çalışmayacağından dolayı başka bir anabolizon eklecekse 17 grubundan(örn:boldenon,primobolon) ekleme yapılmalıdır.', trademark: iron_pharma, price: 180, category: "Enjeksiyon Steroidler", image: 
File.new("#{Rails.root}/app/assets/images/IP1.png")
Product.create title: 'Iron Pharma Deca 200 mg', description: 'Deca Mix 4 esterli Bir deca türevidir.Decadan kısaca bahsedecek olursak bulk amaçlı kullanılan en etkili maddedir.Definasyon döneminde kullanılması uygun olmaz.Bu sebebi Deca Vücuda kas kazanımı yaparken yanında tutacağı su kütlesinden dolayı hatlı görünümü engeller.Deca 19-a Grubu dahildir 17 grubuna göre çok daha yüksek anabolik güce sahiptir.Resöptörlere çok güçlü bağlanır yanında başka bir 19-a(örn trnbolone) grubu kullanıldığında resöptörü kapattığı için 2.19-a grubu maddemiz tam randımanlı çalışmayacağından dolayı başka bir anabolizon eklecekse 17 grubundan(örn:boldenon,primobolon) ekleme yapılmalıdır.', trademark: iron_pharma, price: 150, category: "Enjeksiyon Steroidler", image: 
...
Product.create title: 'Iron Pharma Tren Mix 150 mg', description: 'Deca Mix 4 esterli Bir deca türevidir.Decadan kısaca bahsedecek olursak bulk amaçlı kullanılan en etkili maddedir.Definasyon döneminde kullanılması uygun olmaz.Bu sebebi Deca Vücuda kas kazanımı yaparken yanında tutacağı su kütlesinden dolayı hatlı görünümü engeller.Deca 19-a Grubu dahildir 17 grubuna göre çok daha yüksek anabolik güce sahiptir.Resöptörlere çok güçlü bağlanır yanında başka bir 19-a(örn trnbolone) grubu kullanıldığında resöptörü kapattığı için 2.19-a grubu maddemiz tam randımanlı çalışmayacağından dolayı başka bir anabolizon eklecekse 17 grubundan(örn:boldenon,primobolon) ekleme yapılmalıdır.', trademark: iron_pharma, price: 200, category: "Enjeksiyon Steroidler", image: 
File.new("#{Rails.root}/app/assets/images/IP4.png")

Product.create title: 'Iron Pharma Deca MİX 400 mg', description: 'Deca Mix 4 esterli Bir deca türevidir.Decadan kısaca bahsedecek olursak bulk amaçlı kullanılan en etkili maddedir.Definasyon döneminde kullanılması uygun olmaz.Bu sebebi Deca Vücuda kas kazanımı yaparken yanında tutacağı su kütlesinden dolayı hatlı görünümü engeller.Deca 19-a Grubu dahildir 17 grubuna göre çok daha yüksek anabolik güce sahiptir.Resöptörlere çok güçlü bağlanır yanında başka bir 19-a(örn trnbolone) grubu kullanıldığında resöptörü kapattığı için 2.19-a grubu maddemiz tam randımanlı çalışmayacağından dolayı başka bir anabolizon eklecekse 17 grubundan(örn:boldenon,primobolon) ekleme yapılmalıdır.', trademark: iron_pharma, price: 180, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP1.png")
Product.create title: 'Iron Pharma Deca 200 mg', description: 'DOZAJ FORMU

250 mg / ml
ENDİKASYONLARI

İyi etki, kas büyümesi, iştah uyarıları ve artmış kırmızı kan hücresi üretimi ve kemik yoğunluğunu içerir. Klinik çalışmalar, anemi, osteoporoz ve göğüs kanseri dahil olmak üzere bazı neoplazi formlarının tedavisinde etkili olduğunu ve aynı zamanda bir progestin esaslı kontraseptif olarak hizmet ettiğini göstermiştir. Bu nedenlerle, Birleşik Devletler’deki Nandrolone 1983’te FDA onayı aldı.
YAN ETKİLER
...
200-1000 mg / hafta', trademark: iron_pharma, price: 150, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP2.png")
...
Boldenon diğer adıyla equipoise vücut geliştirmeciler ve atlet`ler tarafından dayanıklılığı artırmak, kas kütlesini artırmak ve kırmızı kan hücrelerini artırmak için kullanılır. Boldenon ile ilgili bilmeniz gereken tek şey yavaş ama kaliteli kas kütlesi kazandırmasıdır.

Son yıllarda powerlifter`lar ve vücut geliştirmeciler deca durabolin yerine en ideal steroid olarak boldenonu tercih etmeye başlamışlardır. Bunun nedeni boldenon ile çok daha az yan etki ile çok daha kaliteli kas ve güç kazanımıdır. Ayrıca boldenon vücutda kan akışını kolaylaştırıp kaslara daha fazla kan gitmesini sağlar, kısaca kırmızı kan hücrelerini artırır.

Erkekler için; 400-600mg haftalık dozaj yeterlidir.

Bayanlar için; 50-100mg haftalık dozaj yeterlidir.', trademark: iron_pharma, price: 180, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP3.png")
...
Trenmix yüksek anabolik değere sahiptir. Sporcular tarafından genelde kaliteli saf kas yağ yakımı amacıyla kullanılır aynı şekilde diyet yapmadan yağ yakımı sağlamaktadır. Kaliteli beslenme ile çok hızlı şekilde kas kütlesi artışı sağlamaktadır. Trenmix kullanımı maximum 10 hafta önerilir, 10 haftayı geçen kürlerde karaciğer ve böbrek yorgunluğu yaşanır. Trenmix hem uzun ester hem kısa ester trenbolone barındırmaktadır bu yüzden 3 günde 1 enjeksiyon önerilir. Trenmix kullanırken bol su tüketmeniz gerekmektedir.
Kullanımı ve Dozajlama

Yeni başlayan sporcular için haftalık 150mg – 300mg arası kullanımı önerilir.
İleri seviye sporcular için haftalık 300mg – 600mg arası kullanımı önerilir.
Yan Etkiler
...
– Uyku sorunu.
– Yorgunluk Hissi.
– Terleme.', trademark: iron_pharma, price: 200, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP4.png")
Product.create title: 'Iron Pharma Tren Enantat', description: 'DOZAJ FORMU

200 mg / ml
ENDİKASYONLARI

Trenbolone Enanthate, kas büyümesini ve iştahı artırmak için hayvanlar üzerinde veteriner hekimler tarafından kullanılan steroiddir. Etkin yarı ömrünü artırmak için, trenbolon rafine edilmemiş bir biçimde kullanılmaz, daha çok trenbolon asetat olarak uygulanır. Trenbolone, son derece popüler olan steroid nandrolona benzemektedir, çünkü hem 19 hem de steroidler, yani bir testosteron molekülünün 19. konumda yeni bir bileşik vermesi için değiştirilmiş demektir. Nervrolone’dan farklı olarak, trenbolon mükemmel bir kütle ve sertleşme ilacı olup, kazanımların çoğunluğu kas lifidir ve minimum su tutma özelliğine sahiptir.
YAN ETKİLER
...
Haftada 300-600 mg.', trademark: iron_pharma, price: 180, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP5.png")
...
75-150 mg / 2 gün', trademark: iron_pharma, price: 165, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP6.png")
Product.create title: 'Iron Pharma Testo Propinat 100 mg', description: 'DOZAJ FORMU

100 mg / ml
ENDİKASYONLARI

Testosteron, androjen grubundan alınan bir steroid hormondur. Memelilerde, testosteron öncelikle erkeklerin testislerinde ve dişilerin yumurtalarında salgılanır, ancak küçük miktarlar da adrenal bezler tarafından salgılanır. Başlıca erkek cinsel hormonu ve bir anabolik steroiddir. Hem erkeklerde hem de kadınlarda testosteron, sağlıkta ve refahta olduğu kadar cinsel işlevlerde de önemli bir rol oynamaktadır. Örnekler arasında libido artışı, artan enerji, kırmızı kan hücrelerinin artan üretimi ve osteoporoza karşı koruma bulunmaktadır. Ortalama olarak yetişkin bir insan vücudu yetişkin bir kadın vücudundan yaklaşık 40-60 kat daha fazla testosteron üretir, ancak kadınlar hormona daha duyarlıdır.
YAN ETKİLER
...
50-100 mg / 2 gün', trademark: iron_pharma, price: 115, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP7.png")
Product.create title: 'Iron Pharma Testo Cypionat 200 mg', description: 'Dozaj formu

250 mg / ml
Endikasyonları

Enantasyondan biraz daha “kick” sağlayan üstün bir ürün olması için testosteron cypionate. Aynı zamanda, biraz daha yüksek bir su tutma seviyesi ürettiği söylenir, ancak kolayca anlaşılması için yeterli değildir. Tabii ki duruma objektif baktığımızda, bu iki steroidin gerçekten değiştirilebilir olduğunu ve cypionate’in hiç de üstün olmadığını görüyoruz. Her ikisi de uzun etkili yağ bazlı enjektabllardır ve bu testosteron seviyelerini yaklaşık iki hafta boyunca yeterince yükseltilmiş tutacaktır. Enantant testosteron salınımı açısından biraz daha iyi olabilir, çünkü bu ester cypionate’den bir karbon atomudur. Fakat fark çok önemsizdir, ancak hiç kimse haklı olarak farkedilebileceğini iddia edemez. Her ne olursa olsun, cypionate ABD karaborsasında çok yüksek bir süredir testosteron esteri olarak yerini aldı.
Yan etkiler
...
200mg – 2000 mg / hafta', trademark: iron_pharma, price: 130, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP8.png")
...
100 mg / 2 gün', trademark: iron_pharma, price: 145, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP9.png")
...
Boldenon diğer adıyla equipoise vücut geliştirmeciler ve atletler tarafından dayanıklılığı artırmak, kas kütlesini artırmak ve kırmızı kan hücrelerini artırmak için kullanılır. Boldenon ile ilgili bilmeniz gereken tek şey yavaş ama kaliteli kas kütlesi kazandırmasıdır.

Son yıllarda powerlifterlar ve vücut geliştirmeciler deca durabolin yerine en ideal steroid olarak boldenonu tercih etmeye başlamışlardır. Bunun nedeni boldenon ile çok daha az yan etki ile çok daha kaliteli kas ve güç kazanımıdır. Ayrıca boldenon vücutda kan akışını kolaylaştırıp kaslara daha fazla kan gitmesini sağlar, kısaca kırmızı kan hücrelerini artırır.

Erkekler için; 400-600mg haftalık dozaj yeterlidir.

Bayanlar için; 50-100mg haftalık dozaj yeterlidir.', trademark: iron_pharma, price: 145, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP10.png")
...
– Uyku sorunu.
– Yorgunluk Hissi.
– Terleme.', trademark: iron_pharma, price: 150, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP11.png")
Product.create title: 'Iron Pharma Testesteron Enantat', description: 'DOZAJ FORMU

250 mg / ml
ENDİKASYONLARI

Kas içine enjekte edilen yağdaki testosteron Enanthate lipid fazından yavaşça absorbe edilir; Bu nedenle Testosteron Enanthate iki ila dört hafta aralıklarla verilebilir. Plazmada testosteron, yüzde 98, özgül bir testosteron-östradiol bağlayıcı globuline bağlıdır ve yaklaşık iki yüzde serbesttir. Genel olarak, plazmada bu SHBG miktarı testosteronun serbest ve bağlı formlar arasındaki dağılımını belirleyecek ve serbest testosteron konsantrasyonu yarı ömrünü belirleyecektir. Testosteron dozunun yaklaşık yüzde 90’ı testosteron glukuronik ve sülfürik asit konjugatları ve metabolitleri olarak idrarla atılır; Bir dozun yaklaşık% 6’sı dışkılarda, çoğunlukla konjuge edilmemiş formda atılır. Testosteronun inaktivasyonu öncelikli olarak karaciğerde gerçekleşir. Testosteron iki farklı yol ile çeşitli 17-keto steroidlere metabolize olur. Literatürde bildirilen testosteronun yarılanma ömründe önemli değişiklikler vardır, bunlar 10 ila 100 dakika arasında değişir. Postmenopozal dönemden bir ila beş yıl önce ilerlemiş, inoperable metastatik (iskelet) meme kanseri olan kadınlar. Bu kadınların tedavisinde birincil amaçlar yumurtalıkların ablasyonudur. Bunları alan kadınlar meme kanseri geliştirme riskleridir.
YAN ETKİLER
...
250 – 1250 mg / hafta', trademark: iron_pharma, price: 130, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP12.png")
Product.create title: 'Iron Pharma Testesteron Sustanon', description: 'Açıklama

Testosterone Propionate…………….30mg/ml
Testosterone Phenyl Propionate…..60mg/ml
Testosterone isocorporate………….60mg/ml
...
Olası yan etkiler jinekomasti, akne, libido azalması, testislerin büzülmesi, vücudun suyunu korumak için yüksek afiniteye sahip olması nedeniyle kan basıncının artırılması, prostat boyutunun ve idrara çıkma zorluğunun artması, erkek tipi kellik, estrojenik yan nedeniyle artmaktadır. östrojen ve östrojen etkilerinin yanı sıra klitorisin genişlemesine yol açabilir.
Etkin Doz
...
250-1000 mg / hafta.
', trademark: iron_pharma, price: 170, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/IP13.png")
...
Haftada 300-600 mg.', trademark: generics_pharma, price: 160, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP1.png")
...
75-150 mg / 2 gün', trademark: generics_pharma, price: 155, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP2.png")
...
50-100 mg / 2 gün', trademark: generics_pharma, price: 110, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP3.png")
...
250 – 1250 mg / hafta', trademark: generics_pharma, price: 110, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP4.png")
...
200mg – 2000 mg / hafta', trademark: generics_pharma, price: 105, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP5.png")
...
75-150 mg / 2 gün', trademark: generics_pharma, price: 155, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP7.png")
...
100 mg / 2 gün', trademark: generics_pharma, price: 210, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP8.png")
...
100 mg / 2 gün', trademark: generics_pharma, price: 150, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP9.png")
...
200-1000 mg / hafta', trademark: generics_pharma, price: 130, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP10.png")
...
Bayanlar için; 50-100mg haftalık dozaj yeterlidir.', trademark: generics_pharma, price: 140, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP11.png")
...
Aquator (Testosteron Base) Dozajı: Haftada 50-400 mg', trademark: generics_pharma, price: 120, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP12.png")
...
200-1000 mg / hafta', trademark: generics_pharma, price: 140, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP13.png")
...
– Uyku sorunu.
– Yorgunluk Hissi.
– Terleme.', trademark: generics_pharma, price: 170, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GP14.png")
...
Omega meds ürünlerimizin orjinalliğini http://omega-meds.com/authenticate.php resmi sitesinden doğrulayabilirsiniz.
DOZAJ FORMU
...
200-1000 mg / hafta', trademark: omega_meds, price: 160, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM1.png")
...
– Uyku sorunu.
– Yorgunluk Hissi.
– Terleme.', trademark: omega_meds, price: 180, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM2.png")
...
Haftada 300-600 mg.', trademark: omega_meds, price: 180, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM3.png")
...
50-100 mg / 2 gün', trademark: omega_meds, price: 140, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM4.png")
...
250 – 1250 mg / hafta', trademark: omega_meds, price: 145, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM5.png")
...
200mg – 2000 mg / hafta', trademark: omega_meds, price: 140, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM6.png")
...
Bayanlar için; 50-100mg haftalık dozaj yeterlidir.', trademark: omega_meds, price: 155, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM7.png")
...
Sustanon, sporcular için özel olarak tasarlanmış testosteronun farklı esterlerinin bir kombinasyonudur. Sporcuların ve vücut geliştiricileri için en önemli yararı, ayda sadece bir kez enjekte edilmesi, bu nedenle ayda bir kez doktor ziyaret etmesi ve bunun yanında diğer steroidlerin de kullanılabilmesidir. Kas büyümesine ve yağ kaybına neden olur. Dolayısıyla bu steroid anabolik ve güçlü kataboliktir. Aynı zamanda eritropoezi artırma ve kas oksijen alımını artırma kapasitesine sahiptir. Yüksek oksijen kası alımı nedeniyle, yorucu egzersiz bile kolaylıkla halledilebilir. Agresifliği nöromüsküler bulaş yoluyla artırabilir. Bu ilacı kullanarak kilo verme dikkat çekicidir. Atletler tarafından kas sayı ve görünümünü arttırmak için kullanılır. Anabolik ve katabolik aktiviteleri nedeniyle spor adamları arasında vücuttan yağ kaybetmek çok popülerdir. Aslında kas kütlesini arttırmaz, ancak kas sayılarına konsantre olur. Eritropoez önemli ölçüde artar ve bazı anemilerde kullanılır. Glikojen sentezinin gerekli olduğu koşullarda kullanılır. Vücut geliştiriciler, oyunu saldırganlığı artırmak için kullanırlar. Sporcular aşırı antrenman nedeniyle kullanıyorlar.', trademark: omega_meds, price: 155, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM8.png")
...
75-150 mg / 2 gün', trademark: omega_meds, price: 180, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/OM9.png")
...
Bayanlar için; 50-100mg haftalık dozaj yeterlidir.', trademark: genesis_pharma, price: 170, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GM1.jpg")
...
200-1000 mg / hafta', trademark: genesis_pharma, price: 170, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GM2.jpg")
...
50 – 100 mg / 2 gün', trademark: genesis_pharma, price: 180, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GM3.jpg")
...
200mg – 2000 mg / hafta', trademark: genesis_pharma, price: 150, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GM4.jpg")
...
250 – 1250 mg / hafta', trademark: genesis_pharma, price: 150, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GM5.jpg")
...
50-100 mg / 2 gün', trademark: genesis_pharma, price: 140, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GM6.jpg")
...
Haftada 300-600 mg.', trademark: genesis_pharma, price: 220, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GM8.jpg")
...
75-150 mg / 2 gün', trademark: genesis_pharma, price: 210, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/GM9.jpg")
...
Bayanlar için; 50-100mg haftalık dozaj yeterlidir.', trademark: jd_pharma, price: 130, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD1.jpg")
...
200-1000 mg / hafta', trademark: jd_pharma, price: 130, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD2.jpg")
...
Sustanon, sporcular için özel olarak tasarlanmış testosteronun farklı esterlerinin bir kombinasyonudur. Sporcuların ve vücut geliştiricileri için en önemli yararı, ayda sadece bir kez enjekte edilmesi, bu nedenle ayda bir kez doktor ziyaret etmesi ve bunun yanında diğer steroidlerin de kullanılabilmesidir. Kas büyümesine ve yağ kaybına neden olur. Dolayısıyla bu steroid anabolik ve güçlü kataboliktir. Aynı zamanda eritropoezi artırma ve kas oksijen alımını artırma kapasitesine sahiptir. Yüksek oksijen kası alımı nedeniyle, yorucu egzersiz bile kolaylıkla halledilebilir. Agresifliği nöromüsküler bulaş yoluyla artırabilir. Bu ilacı kullanarak kilo verme dikkat çekicidir. Atletler tarafından kas sayı ve görünümünü arttırmak için kullanılır. Anabolik ve katabolik aktiviteleri nedeniyle spor adamları arasında vücuttan yağ kaybetmek çok popülerdir. Aslında kas kütlesini arttırmaz, ancak kas sayılarına konsantre olur. Eritropoez önemli ölçüde artar ve bazı anemilerde kullanılır. Glikojen sentezinin gerekli olduğu koşullarda kullanılır. Vücut geliştiriciler, oyunu saldırganlığı artırmak için kullanırlar. Sporcular aşırı antrenman nedeniyle kullanıyorlar.', trademark: jd_pharma, price: 120, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD3.jpg")
...
200mg – 2000 mg / hafta', trademark: jd_pharma, price: 110, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD4.jpg")
...
250 – 1250 mg / hafta', trademark: jd_pharma, price: 110, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD5.jpg")
...
50-100 mg / 2 gün', trademark: jd_pharma, price: 100, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD6.jpg")
...
75-150 mg / 2 gün', trademark: jd_pharma, price: 130, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD7.jpg")
...
Haftada 300-600 mg.', trademark: jd_pharma, price: 135, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD8.jpg")
...
75-150 mg / 2 gün', trademark: jd_pharma, price: 135, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD9.jpg")
...
100 mg / 2 gün', trademark: jd_pharma, price: 130, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD10.jpg")
...
50 – 100 mg / 2 gün', trademark: jd_pharma, price: 125, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/JD11.jpg")
...
Diğer yandan ilacın bazı yan etkileri görülebilir. Diğer ilaçlara göre bu ilacın genellikle çok daha az yan etkisi vardır. Vücutta su çok az miktarda tutulur. Bu nedenle güreşçiler, bilek güreşçileri ve su sporları ile ilgili güç yükleyicileri için avantaj olabilir.
...
Kombine:Uzun esterli bir steroid olduğu için en güzel ve en verimli kombinasyonu yine uzun esterli olan Testesteron Enanthat ve Testesteron Cypionate gibi uzun esterli ürünlerle kullanan kişiler en etkili sonucu elde edebilirler.', trademark: leon_labs, price: 110, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/LL1.jpg")
...
Buna ilaveten ilacın düzenli kullanım sürecinden sonra Post Cycle Therapy(Kür sonu tedavisi) sürecini daha fazla uzatmak için yardımcı olacaktır. Boldever hızlı bir vücut geliştirici ilaç değildir fakat düzenli olarak kullanıldığı zaman uzun vadede vücudunuzu bir canavara çevirebilir. Özellikle 12.haftadan sonraki kullanımlarda devasal etkiler yaratır.
...
', trademark: leon_labs, price: 100, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/LL2.jpg")
...
Ben Johnson`a mucizevi kosular yaptiran, bu anabolizandir. Kullanan birçok profesyonel vücutçunun, ölçülü ve sert definisyon görünümü buna misal teskil etmektedir. Ilk doping testlerinin yapildigi (Arnold Classic 1990) yarismalarinda, iyi dereceler yapmis bulunan taninmis vücutçular Shawn Ray ve Nimrod King`de, yapilan testlerde Stromba(Stanozolol)`a rastlanmistir. Bu husus Dünya Vücut gelistirme Federasyonu`nün yayin organi olan Flex Mecmuasi`nin Temmuz 1990 sayisinda belirtilmistir. İtiraf etmek gerekirse, bu kadar tutulan Winstrol`ün, dogru tatbik edildigi taktirde, çok etkli oldugu gözlenmektedir. Enjekte edilen igne Stromba(Stanozolol), tablet oranina göre daha etkilidir.

Stromba(Stanozolol) diger steroidlere göre en önemli degisik özelligi, yagda degil suda çözülmesidir. Bunun anlami suda çözülen steroidlerin etkisi, yagda çözülen steroidlere nazaran daha kisa sürelidir. Bu da yagda çözülen Primabolan, Deca-Durabolin, Sustanon v.s. gibi steroidlere nazaran daha sık sürelerde kullanilmasina sebep olmaktadir.

Su tutmama özelligi dolayisiyle yarisma öncesi dönemlerde kullanilan Stromba(Stanozolol), bulk dönemi denilen, yagli ve hacimli ölü sezon devrelerinde de kullanilmaktadir.Bu devrede su tutmadigi için kilo artisi yapmasa bile, yaglanmaya müsait sporcularda, kaliteli ve yagsiz adele artisi ile kuvvet arttirimina sebep olur.

Kombinasyon: Hacim alma meraklilari, Stromba (Stanozolol) ile birlikte, Dianabol, Anapolon, Testosteron veya Deca Durabolin karisimi kürler uygulamaktadirlar. Bazi profesyonel sampiyon vücutçular, günde 100 mg anapolon ve 50 mg (stromba)Stanozolol kullanmaktadirlar. Yaşlı ve Çaylak tabir edilen yeni sporcularin da bunun biraz daha az dozunda kürler yaptigi ifade edilmektedir.
...
', trademark: leon_labs, price: 120, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/LL3.jpg")
...
Erkeklerde çocuk yapma kabiliyetini arttirir. Şimdiye kadar kullanılan en popüler Testosteron türü olmuştur. Uzun süreli anabolik, androjenik etkili steroidtir. Bu ürün, şimdiye kadar üretilen en iyi sentezlenmiş ve en uygun testosteron olarak bilinir. Testosteron Enantat bir başka önemli özelliği de fiyatı oldukça düşüktür.
Ayrıca Testosteron Propionat, Testosteron Cypionate gibi tüm testosteron hormonlarını içinde barındırır. Fakat araştırmalar gösteriyor ki Testosteron Enantat etkisi çok daha güçlüdür yani anabolik etkisi çok yüksektir. Testosteron Propionat etkileri kaslar üzerinde azot retansiyonu ve protein sentezi üzerine sürer. Bu süreç hızlı kas kazanımına yardımcı olur. Aynı zamanda aktif metabolizma hızı artar. Testosteron Propionat da vücutta IGF-1 düzeylerini artırır böylece Peptid hormonunu tetikleyerek güçlü anabolik öz niteliklere yardımcı olur. Testosteron Enantat düzeyleri arttığı zaman vücuttaki hızlı toparlamayı ve gücü görebilmek mümkündür.
...
', trademark: leon_labs, price: 90, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/LL4.jpg")
...
Kullanımı: 8 Haftalık Kürler için.

70–80 kilogram ağırlığındaki sporcular ilk 4 hafta 200mg sonraki 5–8 haftalarda 300mg Trenbolone alabilirler. Bunun yanında genellikle libido seviyenizi dengelemeniz açısından kür boyunca 40–50 mg proviron önerebiliriz. Proviron kullanımında Testosterone hormonlarının hücrelere bağlanmasında yardımcı olur ve daha iyi kombine olurlar. Böylece kendi hormon seviyenizde çok düşmemiş olur.

80–100 kilogram ağırlığındaki sporcularda ise ilk 4 hafta 300mg ile başlanır, 5-6 Haftalarda 400mg alınabilir ve son 7-8 haftalarda 500mg a kadar çıkılabilir. Bu sefer ise günlük 75mg proviron almanızı öneririm. Jinekomasti gibi bir durum olursa eğer günlük 2.5mg letrozol alabilirsiniz. 500mg Trenbolone kullananlar çok agresif bir yapıya sahip olabilirler.

100 kilogram ve üzeri sporcularda ise ilk 4 hafta 400mg sonrasında ise 5–8 haftalar arasında 500mg önerebilirim.
...
', trademark: leon_labs, price: 120, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/LL5.jpg")
...
Testosteron esterleri kas gelişimi için çok önemli bir hormondur. Sustaver anabolik ve katabolik faliyetleri ile yağ yakmak çok kolay olduğundan sporcular ve vücut geliştiriciler tarafından Definasyon sırasındada tercih edilmektedir. 4. haftada etki başlar. İyi bir beslenme Protein alma ile düzenli bir uyku 6-7 kg kas kütlesi elde etmenizi sağlar. Ancak bu oran özel şartlar açısından değişebilir.

Kullanımı: Sustanon haftada 1 kere kalça içine yada kas içine enjekte edilir. 8 ila 24 hafta arası kullanılabilir. En az kürünüzde 8 hafta kullanılmalıdır. Sustaver başlama dozu haftada 250 mg dır. Kullanım sırasında bu miktar daha da artar. Bu, hafta başına 1000mg a kadar kullanılabilir.
...
', trademark: leon_labs, price: 110, category: 'Enjeksiyon Steroidler', image: File.new("#{Rails.root}/app/assets/images/LL6.jpg")
...
Her nasılsa bu özelliklere karşıt enteresan bir özelliği daha vardır bu ilacın, çok fazla oxymetholone(anadrol) kullanımı ciddi derecede iştah düşüşüne neden olabilir ve kilo kazanımını zor hale getirebilir. Unutulmamalıdır ki kişi iyi beslenemez ise iyi şekilde de gelişemez.

Dihydrotestosterone (DHT) türevinden türeyen Anadrol,17 Alpha Alkylated steroidtir (17-aa). 17 aa kimyasal olarak 17.karbon durumuyla değiştirilmiş ve bu sayede first pass (ağızdan geçiş) yoluyla metabolizma da çalışması sağlanmıştır. Bu değişikliğin iyi yanı kuvvetli bir anabolik steroidi oral yolla alabilecek olmamızdır,bu durumun kötü yanı ise karaciğere toksit etkisidir.

Karaciğere toksit etkisi olduğundan bahsetmiştik ,bu olumsuz durumu karaciğer enzimlerini yükselterek yapmaktadır. Buna rağmen bilinçli ve fazla olmayan kullanımda karaciğerin mükemmel derecede olan kendini toparlama gücü sayesinde ciddi zarardan büyük ölçüde kaçılınabilmektedir. Karaciğer bir kürden sonra kısa sürede eski değerlerine kendiliğinden dönebilmektedir.
...
Kullanım dozajı; Günlük 50mg olarak tavsiye edilir. Tıp alanında doktorların tavsiye ettiği kullanım da günlüktür ve kg başına 1.5 mgdır. Performans arttırıcı olarak kullanılan Anapolon dozajını hastaların kullandığı dozajdan ayırmak gerekmektedir.', trademark: balkan, price: 140, category: 'Tablet Steroidler', image: File.new("#{Rails.root}/app/assets/images/BP1.jpeg")
...
Uzman dopingciler, 8 hafta sonunda ilacin etkisi azalmaya başlayacağından, danabol kürüne devam etmek istiyenlere, dozu arttırmamalarını, bunun yerine enjekteli bir steroidi eklemelerini veya danabol`ü birakip diger bir steroide geçis yapmalarini tavsiye etmektedirler. Örnek verilirse; Deca-Durabolin haftada 200mg veya Primabolan haftada 200 mg olarak kullanilmaktadır. Daniel Duchaine`nin kitabinda: "Deca ve Danabol ile adele yapamayip netice alamiyanlarin bu isi birakmalari" önerilmektedir.
...
Halotestin hematocrit (kan hacmine göre alyuvarların-kanın şekilli elementlerinin-belirlenmesidir) ve hemoglobin (eritirioritlerde bulunan,molekül ağırlığı 68000 olan ve oksijen taşımakla görevli olan demir içeren kırmızı renkteki heteroprotein. Hemoglobin dokulardan karbondioksidi alıp,akciğerlerde oksijenle değişimini sağlar ve dokulara böylece oksijen taşınır) seviyelerini artırabilir,tıpkı vücudumuzda bulunan kendi kırmızı büyüme hücrelerimizin yaptığı gibi. Halotestin ayrıca enythropoietine bağlı olan hücrelerin yaptığı işleri de vücutta ekstradan yapmaktadır,bu da kuşkusuz atletlere daha fazla enerji,ekstra güç sağlamaktadır. Görüldüğü üzere halotestin vücudumuzdaki kırmızı kan hücrelerinin üretiminde derin ve önemli katkılara sahip. Peki biz sporculara bunun katkısı ne? Yukarıda yazılan tüm bilimsel açıklamalar gösteriyor ki halotestin açıkça güç artışı,enerji seviyesinde yükselme ve vücutta tıkır tıkır işleyen bir mekanizme sahip. Sporculara getirdiği olumlu bir noktada Rugby gibi,karışık dövüş sanatları gibi branşlarda çok işe yaramasıdır.

Unutulmamalıdır ki Halotestin özellikle definasyonda ve kuvvet artırmada etkilidir,büyüme ve kilo kazanma amaçlı olarak Halotestin kullanan sporcular hayal kırıklığına uğramaktadırlar.
...
Kullanımı: 15-25mg Günlük kullanım için uygundur.', trademark: balkan, price: 250, category: 'Tablet Steroidler', image: File.new("#{Rails.root}/app/assets/images/BP4.jpg")
...
Kombine: Oxandrolone, günde 10-20mg Halotestin veya 120-140mcg Clenbuterol ile birlikte kullanılabilir. Oxandrolon alınacak diğer steroidlerin etkisinide arttırır. Deca, Dianabol ve Testosteronlar ile birlikte kürlerde hacim almak için kullanılır. Kombine olabildiği birçok ilaç vardır. Testestorone nun tüm veryasyonları ile kombine edilebilir. Özellikle primobolan ile en iyi efektif sonuçları verir. Her gün 30mg Oxandrolone ile Winstrol, Parabolan, Masteron, Primobolan ve Testosteron Propionat başta olmak üzere diğer steroidlerlede kombine edilebilir.', trademark: balkan, price: 160, category: 'Tablet Steroidler', image: File.new("#{Rails.root}/app/assets/images/BP5.jpg")
Product.create title: 'Balkan Pharma Strombafort 10mg 60 tablet (Winstrol,Stanozolol)', description: 'Dozaj formu

10 mg / tablet
Endikasyonları

Stanozolol, FDA tarafından insan kullanımı için onaylanmış sentetik bir anabolik steroiddir. Testosterondan türemiştir. Stanozolol, oral biyoyararlanımı yüksektir, çünkü karaciğer metabolizması boyunca hayatta kalır ve bu nedenle tablet formundadır. Nihai ürün olarak östrojen üretmez. Stanozolol, büyük anabolik etkisi ve kötü androjenik etkileri nedeniyle kadın vücut geliştiricileri arasında popülerdir; ancak virilizasyon ve maskülinizasyon en sık görülen yan etkilerdir. Stanozolol, IAAF ve diğer birçok spor organları spor etkinliklerinde kullanımı yasaklar. Stanozolol anabolik etkileri nedeniyle vücut geliştiricilerinde popülerdir; çünkü herhangi bir su tutma ve kilo vermeden zayıf vücut kütlesi tutma eğilimindedir. stanozololün yağ yakıcı bir ilaç olduğu düşünülmekte ancak bunu destekleyen çok az kanıt bulunmaktadır. Erkek vücudu güçlendirmek için vücut geliştirme görevlileri tarafından anabolik etkiler için kullanılır. Klinik olarak, insan anemisinde ve kalıtsal anjioödem tedavisinde hekimler arasında popüler olan olağanüstü bir başarı ile kullanılır. Veterinerlikte zayıf hayvanlarda artan vücut kitlesi kan sayımı ve iştahı artırmak için kullanılmıştır. Stanozolol, yarış hazırlığında at yarışında metabolik bir eksipiyan olarak kullanılır. Doz 10-25 mg / gün ve optimum sonuç 50 mg / gün’dür.
Yan etkiler
...
10-30 mg / gün', trademark: balkan, price: 60, category: 'Tablet Steroidler', image: File.new("#{Rails.root}/app/assets/images/BP6.jpg")
...
Kullanım; Erkekler için günde 4-8 tablet kullanımı uygundur, bayanlarda 2-4 tablet.  Hem hacim kürlerinde hemde kas korumalı yağ yakım kürlerinde kullanılabilir.', trademark: balkan, price: 115, category: 'Tablet Steroidler', image: File.new("#{Rails.root}/app/assets/images/BP7.jpg")
...
Kombine: Oxandrolone, günde 10-20mg Halotestin veya 120-140mcg Clenbuterol ile birlikte kullanılabilir. Oxandrolon alınacak diğer steroidlerin etkisinide arttırır. Deca, Dianabol ve Testosteronlar ile birlikte kürlerde hacim almak için kullanılır. Kombine olabildiği birçok ilaç vardır. Testestorone nun tüm veryasyonları ile kombine edilebilir. Özellikle primobolan ile en iyi efektif sonuçları verir. Her gün 30mg Oxandrolone ile Winstrol, Parabolan, Masteron, Primobolan ve Testosteron Propionat başta olmak üzere diğer steroidlerlede kombine edilebilir.', trademark: muscle, price: 140, category: 'Tablet Steroidler', image: File.new("#{Rails.root}/app/assets/images/ML3.jpg")
...
10-30 mg / gün', trademark: muscle, price: 100, category: 'Tablet Steroidler', image: File.new("#{Rails.root}/app/assets/images/ML5.jpg")
...
Kullanım dozajı; Günlük 50mg olarak tavsiye edilir. Tıp alanında doktorların tavsiye ettiği kullanım da günlüktür ve kg başına 1.5 mg`dır. Performans arttırıcı olarak kullanılan Anapolon dozajını hastaların kullandığı dozajdan ayırmak gerekmektedir.', trademark: muscle, price: 100, category: 'Tablet Steroidler', image: File.new("#{Rails.root}/app/assets/images/ML6.jpg")
...
Folistatin 344 Kullanımı; Tercihen sabah veya antrenmandan önce alınması tavsiye edilir. 50-100mcg arası günlük dozaj.', trademark: kingtropin, price: 350, category: 'Peptidler', image: File.new("#{Rails.root}/app/assets/images/KT1.jpg")
Product.create title: 'King igf lr 3', description: 'IGF1-LR3 FAYDALARI;

Yağsız Kas Artışı
Yağ yakımı
Mental fonksiyonlarda iyileşme

Igf1 çocuklarda kemik uzamasını sağlar, yetişkinlerde kas büyümesi ve yırtılan kasların daha çabuk tedavi edilmesinde görevlidir. İgf1-lr3 normal igf1`den çok daha etkilidir, Daha etkili olmasının sebebi vücutda kalma süresidir. İgf1`in etkisi 20 dakika sürerken igf1-lr3 20-30 saat etkilidir.

Growth Hormonu mu yoksa Igf1-lr3 mü?

Igf1-lr3 kas artışına doğrudan etki ederek daha çabuk sonuç verir, Growth yani büyüme hormonu kas artışını dolaylı yoldan destekler, karaciğerde igf1 artışı yaparak büyüme sağlar.

Büyüme Hormonu ve Igf1-lr3 beraber kullanımı?

Bu sorunun cevabı evet büyüme hormonu ve igf1-lr3 beraber kullanılabilir ve çok iyi kombine olur. Antrenmandan sonra 10-20mcg igf-lr3 ve sabah kahvaltısı ile birlikte 2-4iu büyüme hormonu minimum yan etki ile maximum büyüme sağlar.

IGF1-LR3 Kullanımı;

En ideal kullanım miktarı günlük 20-50mcg arasıdır, 20mcg genellikle kullanılan dozajdır. Sabah kalkınca ve antrenmandan hemen sonra kullanımı en kaliteli verimi almanızı sağlar.

İgf1-lr3 kas içine ve deri altına uygulanabilir. 

IGF1-LR3 Kullanım Süresi

8 haftaya kadar kullanılabilir. 

IGF1-LR3 Yan Etkileri;

Yorgunluk, kramp,baş ağrısı,düşük şeker', trademark: kingtropin, price: 250, category: 'Peptidler', image: File.new("#{Rails.root}/app/assets/images/KT2.jpg")
...
Antrenman`dan 2 sonra ve Uyumadan 2 saat önce kullanılmamalıdır.
Günlük dozaj toplam 1400mcg`dir. 1400mcg, günlük 2 veya 3 e bölünmelidir.
Bölgesel olarak uygulanmaktadır. Günlük dozaj, her kas bölgesine eşit şekilde bölünmelidir.

Günlük 1400mcg / Günde 2 seans= 700mcg sabah- 700mcg akşam.

700mcg bir seans/ 4 kas (göğüs, biceps)

180mcg her bir kas grubu için.

60mcg her bir kas grubu içindeki bölgeler için. (alt göğüs, orta göğüs, üst göğüs)', trademark: kingtropin, price: 250, category: 'Peptidler', image: File.new("#{Rails.root}/app/assets/images/KT3.jpg")
...
Hgh Fragment kullanımı; Günlük 250-500mcg arası, sabah-akşam olacak şekilde kullanmanızı tavsiye ederim. Igf1 lr3 ile çok iyi kombine olur.', trademark: kingtropin, price: 250, category: 'Peptidler', image: File.new("#{Rails.root}/app/assets/images/KT4.jpg")
...
Kullanım süresi: Belirli bir kullanım sınırı yoktur.', trademark: kingtropin, price: 250, category: 'Peptidler', image: File.new("#{Rails.root}/app/assets/images/KT5.jpg")
...
Kas artisi isteyenler en az 6-10 unite
Yag yakimi ve sert adele (definisyon) kazanmak isteyenler icin 4 unite yeterli olucaktir.

Bunlar gunluk dozajlardir !!!

Urunun kullanilmasi icin en uygun zaman olarak bence gece yatmadan 1 saat oncedir.okudugum dergiler ve arastrmalar sonucu proflarinda yabanci forumlarda paylastigi bilgi bu yondedir...

Saklama Koşulları; 2 ° C-8 ° C arasında buzdolabında saklanmalıdır.Kış ve bahar aylarında oda sıcaklığında 30 gün saklanılabilir.. Depolama çok önemli piyasada orjinal olupta soğuk zinciri bozulmuş anarmol ucuz fiyatlarda ürünleri satın almayınız.
